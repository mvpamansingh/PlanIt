...
@Composable
fun MediumPriorityScreen(
    viewModel: MediumPriorityViewModel ,
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                onValueChange = { viewModel.OnEvent(MediumPriorityEvents.SearchStateChanged(it)) },
                ...
                items(state.tasks) { task ->
                    TaskCard(
                        task = task, onTaskComplete = { isCompleted->
                            viewModel.OnEvent(MediumPriorityEvents.OnTaskStatusChanged(taskId = task.id, isCompleted= isCompleted))
                        }
